...
.findFirst();
    ...
    public void task8(){
        ...
        Optional<Person> optional = null;
        optional= people.stream().min((a,b)->a.getDateOfBirth().compareTo(b.getDateOfBirth()));
    ...
    public void task10(){
       ...
       optional = people.stream()
               ...
               // below is alternative but its long.....
    ...
    public void task12(){
        ...
        //Write code here
        result= people.stream().map(Person::getFirstName).filter(palindrome)
                .distinct()
                .sorted()
                .toArray(String[]::new);
    ...
    public void task14(){
        ...
        _2020_dates= Stream.iterate(LocalDate.ofYearDay(2020, 1),localDate -> localDate.plusDays(1))
          .limit(366)
